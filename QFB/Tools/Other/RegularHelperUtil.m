...
@implementation RegularHelperUtil
...
+ (BOOL)checkTelNumber:(NSString *) telNumber
{
    ...
    /**
     ...
     16         * 130,131,132,152,155,156,183,185,186,166,198
     17         */
    NSString * CU = @"^1(3[0-2]|5[256]|8[356]|7[0-9]|66|98)\\d{8}$";
//    NSString * CU = @"^1([0-9][0-9])\\d{8}$";
    ...
    /**
     ...
     22         */
    NSString * CT = @"^1((33|53|8[09]|7[37])[0-9]|349)\\d{7}$";
    /**
     25         * 大陆地区固话及小灵通
...
+ (BOOL) checkNumberAndPoint:(NSString *) CheJiaNumber{
