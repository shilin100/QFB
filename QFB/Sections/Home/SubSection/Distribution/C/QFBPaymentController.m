...
- (void)initWebview
{
    ...
    NSString *method = [NSString stringWithFormat:@"/pay/pay.action?price=%.2f&userId=%@&oBrandId=%@&roleId=%@&orderNumber=%@&payType=0",_amountOfPayment, [kDefault objectForKey:USER_IDk], O_BRAND_ID, [kDefault objectForKey:ROLE_IDk], _orderNumber];
