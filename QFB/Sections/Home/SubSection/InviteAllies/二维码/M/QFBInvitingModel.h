...
@property (nonatomic, strong) NSString *value;      // http://122.114.248.156:8888/group1/M00/00/04/enL4nFtoF86AXCGuAAFZSK_4JTI632.png@property (nonatomic, strong) NSString *,
