...
@property (nonatomic, strong) NSMutableArray<QFBAllianceModel *> *modelArray;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.row == 0) {
        ...
        [cell loadCellModel:self.modelArray.firstObject];
        return cell;
    }else
    {
        ...
        [cell setSelectionStyle:UITableViewCellSelectionStyleNone];
        [cell loadCellModel:self.modelArray.lastObject];
        return cell;
    }
}
